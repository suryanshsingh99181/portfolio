  ...
  return (
    ...
    >
      ...
      <div className="flex w-full justify-center gap-2 py-2">
        <a href="#item1" className="btn btn-md btn-outline btn-accent">
          1
        </a>
        <a href="#item2" className="btn btn-md btn-outline btn-accent">
          2
        </a>
        <a href="#item3" className="btn btn-md btn-outline btn-accent">
          3
        </a>
      </div>
    </div>
