...
const ProjectCard = ({ title, main }) => {
  return (
    <div className="w-2/5 p-3 md:p-6 flex flex-col bg-[#0c0e19] shadow-xl shadow-slate-900 rounded-2xl">
      <img className="p-4 rounded-3xl" src={suryansh} alt="bannerimage" />
