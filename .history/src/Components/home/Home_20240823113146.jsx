  ...
  return (
    <div className="bg-gradient-to-tr from-black to to-slate-600 text-white flex w-full justify-between items-start p-10 md:p-20">
      <div className="md:w-2/4 md:pt-10 mt-10">
        ...
        <a
          className=" bg-blue-500 mt-5 ml-4 md:md-10 text-white py-2 h-10 px-3 text-sm md:text-lg md:px-4 hover: duration-200 hover:bg-transparent hover:border-2 hover:border-[#FF7C00] font-semibold rounded-3xl"
