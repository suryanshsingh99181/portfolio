  ...
  return (
    <div className="text-white flex w-full justify-between items-start p-10 md:p-20">
      <div className="md:w-2/4 md:pt-10 mt-10">
        ...
        <button className=" bg-blue-500 mt-5 md:md-10 text-white py-2 px-3 text-sm md:text-lg md:px-4 hover: duration-300 hover:scale-105 font-semibold rounded-3xl bg-[#46]">
          Contact Me
        </button>
      </div>
      <div>
