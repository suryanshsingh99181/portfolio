...
const Navbar = () => {
  ...
  return (
    <nav className="flex flex-wrap justify-between md:items-center text-white px-10 md:px-20 bg-slate-800 ">
      ...
      <ul
        className={`mx-24  py-2 mt-4 font-semibold md:-5 bg-black px-2 align-top rounded-xl bg-opacity-30 md:border-none text-center md:bg-transparent md:static md:mx-0 md:flex gap-6 ${
          menu ? "block" : "hidden"
        }`}
      >
        <a href="#Experience">
