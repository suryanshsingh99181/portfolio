...
const Navbar = () => {
  ...
  return (
    <nav className="flex flex-wrap justify-between md:items-center text-white px-10 md:px-20 bg-slate-800 ">
      <span className="text-2xl font-bold tracking-wide hover:text-blue-500">
        Suryansh.
      </span>
      <ul
      ...
      >
        <a href="#About">
          <li className="text-md transition-all duration-500 p-1 md:p-0 hover:text-blue-500 hover:underline ">
            About
          </li>
        </a>
        <a href="#Experience">
          <li className="text-md transition-all duration-300 p-1 md:p-0 hover:text-blue-500 hover:underline">
            Experience
          </li>
        </a>
        <a href="#Projects">
