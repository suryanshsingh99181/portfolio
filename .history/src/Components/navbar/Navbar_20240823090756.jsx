...
const Navbar = () => {
  ...
  return (
    <nav className="flex flex-wrap justify-between md:items-center text-white px-10 md:px-20 bg-slate-800 ">
      ...
      <ul
        className={`mx-24 mt-3 pb-2 font-semibold md:-5 bg-black px-2 rounded-xl bg-opacity-30 md:border-none text-center md:bg-transparent md:static md:mx-0 md:flex gap-6 ${
          menu ? "block" : "hidden"
        }`}
      >
        <a href="#Experience">
