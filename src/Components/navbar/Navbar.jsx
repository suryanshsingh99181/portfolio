...
const Navbar = () => {
  ...
  return (
    <nav
      id="navbar"
      className="flex flex-wrap justify-between md:items-center text-white px-10 md:px-20 bg-slate-800 "
    >
      <span className="text-2xl font-bold tracking-wide hover:text-blue-300">
        Suryansh.
      </span>
      <ul
        className={`mx-24 mt-3 py-2 font-semibold md:-5 md:border-none  md:bg-transparent md:static md:mx-0 md:flex gap-6 ${
          menu ? "block" : "hidden"
        }`}
      >
        <a href="#Experience">
